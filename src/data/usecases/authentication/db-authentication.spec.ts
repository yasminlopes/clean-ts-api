...
import { UpdateAccessTokenRepository, LoadAccountByEmailRepository, AccountModel, AuthenticationModel, Encrypter, HashComparer } from './db-authentication-protocols'
